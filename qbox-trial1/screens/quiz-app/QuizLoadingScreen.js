        ...
        <SafeAreaView style={PlatformSafeView.PlatformSafeArea} className="bg-white">
            ...
            <View
                ...
                <View
                    ...
                    <BasicButton title="START QUIZ" textStyle={{fontSize: 20, fontWeight: 'bold', color: '#1e3a8a'}} style={{backgroundColor: 'white', paddingVertical: 20, paddingHorizontal: 50, borderRadius: 50}}/>
                </View>
            </View>
        </SafeAreaView>
    );
